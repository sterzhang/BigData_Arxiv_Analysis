...
def main():
    ...
    for page_num in range(0, page_sum, 200):
        ...
        paper.to_csv('arxiv_data.csv', index=False, mode='a', header=not os.path.exists('arxiv_data.csv'))
